...
public class JidianAdapter extends BaseQuickAdapter<JidianData, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder holder, JidianData mJidianData) {
        holder.setText(R.id.tv_bianhao_item_rv_project_jisian_fragment, "编号：" + mJidianData.getBianhao())
                ...
                .setText(R.id.tv_xiuzhenghougaochengzhi_item_rv_project_jisian_fragment, Html.fromHtml("修正后高程值：<font color=black>" + mJidianData.getXiuzhenghougaochengzhi() + "</font>"))
                .setText(R.id.tv_lichengguanhao_item_rv_project_jisian_fragment, Html.fromHtml("里程冠号：<font color=black>" + mJidianData.getLichengguanhao() + "</font>"))
                .setText(R.id.tv_lichengzhi_item_rv_project_jisian_fragment, Html.fromHtml("里程值：<font color=black>" + mJidianData.getLichengzhi() + "</font>"));
    }
}
